...
//		SpringApplication.run(DBtoPdfInSingleClassApplication.class, args);
		...
		try {
			...
			PdfPTable table = new PdfPTable(columnName);
...
//				table.addCell(cell);
				table.addCell(metaData.getColumnName(i).toUpperCase());
			...
			while (rs.next()) {
				...
				cell=new PdfPCell(new Phrase(rs.getString("product_id")));
				table.addCell(cell);
				cell=new PdfPCell(new Phrase(rs.getString("product_desc")));
				table.addCell(cell);
				cell=new PdfPCell(new Phrase(rs.getString("product_name")));
				table.addCell(cell);
				cell=new PdfPCell(new Phrase(rs.getString("product_price")));
				table.addCell(cell);
				cell=new PdfPCell(new Phrase(rs.getString("product_discount")));
				table.addCell(cell);
				cell=new PdfPCell(new Phrase(rs.getString("product_value")));
				table.addCell(cell);
				cell=new PdfPCell(new Phrase(rs.getString("product_thing")));
				table.addCell(cell);
